...
export class CanDeactivateGuardService implements CanDeactivate<CanComponentDeactivate> { //can also pass my class which has Can Deactivate Method, but this is more generic
